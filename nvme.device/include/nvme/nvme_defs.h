...
#define NVME_CAP_MQES(cap)	((u32)((cap) & 0xffffULL))
#define NVME_CAP_TIMEOUT(cap)	((u32)(((cap) >> 24) & 0xffULL))
#define NVME_CAP_STRIDE(cap)	((u32)(((cap) >> 32) & 0xfULL))
#define NVME_CAP_NSSRC(cap)	((u32)(((cap) >> 36) & 0x1ULL))
#define NVME_CAP_CSS(cap)	((u32)(((cap) >> 37) & 0xffULL))
#define NVME_CAP_MPSMIN(cap)	((u32)(((cap) >> 48) & 0xfULL))
#define NVME_CAP_MPSMAX(cap)	((u32)(((cap) >> 52) & 0xfULL))
#define NVME_CAP_CMBS(cap)	((u32)(((cap) >> 57) & 0x1ULL))
...
static inline u8 nvme_elbaf_sts(u32 elbaf)
{
	return elbaf & NVME_ID_NS_NVM_STS_MASK;
}

static inline u8 nvme_elbaf_guard_type(u32 elbaf)
{
	return (elbaf >> NVME_ID_NS_NVM_GUARD_SHIFT) & NVME_ID_NS_NVM_GUARD_MASK;
}

static inline u8 nvme_elbaf_qualified_guard_type(u32 elbaf)
{
...
static inline u8 nvme_lbaf_index(u8 flbas)
{
	return (u8)((flbas & NVME_NS_FLBAS_LBA_MASK) |
...
enum {
	...
	NVME_CMD_EFFECTS_CSER_MASK	= (BIT(14) | BIT(15)),
	NVME_CMD_EFFECTS_CSE_MASK	= (BIT(16) | BIT(17) | BIT(18)),
	NVME_CMD_EFFECTS_UUID_SEL	= 1 << 19,
	NVME_CMD_EFFECTS_SCOPE_MASK	= 0xFFF << 20,
};
